;(function (window, $, undefined) { ;(function () {
    ...
    datepicker.prototype = {
        ...
        _triggerOnChange: function () {
            ...
            // Create new dates array, to separate it from original
			// selectedDates
        ...
        selectDate: function (date) {
            ...
            // Prevent from setting hours or minutes which values are lesser
			// then `min` value or
        ...
        update: function (param, value) {
            ...
            if (this.opts.timepicker) {
                ...
                // Change hours and minutes if it's values have been changed
				// through min/max hours/minutes
                if (lastSelectedDate) {
    ...
    datepicker.getParsedDate = function (date) {
        return {
            ...
            month: date.getMonth(),
            fullMonth: (date.getMonth() + 1) < 10 ? '0' + (date.getMonth() + 1) : date.getMonth() + 1, // One
																										// based
            date: date.getDate(),

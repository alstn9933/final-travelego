...
<body>
	...
	<section>
		<section>			
				...
				<div class="option">
					<div>
						<form onsubmit="searchPlaces(); return false;">
							...
							<button class="btn btn-primary click" data-toggle="modal"
					data-target="#myModal" onclick="enter()">검색하기</button>
						</form>
					</div>
				</div>
			...
			<script>
				...
				function getListItem(index, places) {
					...
					var el = document.createElement('li'), itemStr = '<span class="markerbg marker_'
							+ (index + 1)
							+ '"></span>'
							+ '<div class="info" onclick="select(this)">'
			...
			<script>
			var selected = document.getElementsByClass("info");
			function select(param){
				$(this).siblings().css('display','none');
				$("#pagination").css('display','none');
				$("#menu_wrap").addClass('select');
				$("#map").css('display','inline-block');
				$(".map_wrap").css('height','500px');
				var addr = $(this).find("span").eq(1).html();
				alert(addr);
			};
			
			function enter(){
				$("#menu_wrap").removeClass('select');
				$("#menu_wrap").css('display','inline-block');
			}
...
// 			$(function(){
// 				//주소 검색 후 나타나는 리스트를 클릭했을 시, 나타나는 변화들
// 				$(".item").click(function(){
// 					console.log("asd");
// 					$(this).siblings().css('display','none');
// 					$("#pagination").css('display','none');
...
// 				//키워드 재검색 시, 리스트창 복구(검색 버튼 클릭시)
// 				$(".revoke").click(function(){
// 					$("#menu_wrap").removeClass('select');
// 					$("#menu_wrap").css('display','inline-block');
// 				});
// 				/* //키워드 재검색 시, 리스트창 복구(키보드로 엔터시)
// 				$(".revoke").prev("input").blur(function(){
// 					$("#menu_wrap").removeClass('select');
// 					$("#menu_wrap").css('display','inline-block');
// 				}); */
			})

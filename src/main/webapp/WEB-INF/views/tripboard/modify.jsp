...
${board.tripRoute }</textarea
        ...
        <div class="editor_wrapper">
          <textarea id="editor4" name="tripBoardContent">
${board.tripBoardContent }</textarea
          >
        </div>

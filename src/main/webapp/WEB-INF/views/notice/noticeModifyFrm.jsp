...
<section>
	<div class="mainWrite">
	<form action="/noticeModify.do" method="get">
		<div class="writeHeader">
		<table class="titletable">
			<tr>
				<input type="hidden" name="noticeNo" value="${m.noticeNo }">
				<th class="tableTitle">제목</th>
				<td><input type="text" class="form-control" id="noticeTitle" name="noticeTitle" placeholder="제목란" value="${m.noticeTitle }"></td>
			</tr>
		</table>
		</div>
		<hr>
		<div class="writeContent">
			<textarea rows="20" cols="50" id ="editor" name ="noticeContent"  style="resize: none;" value="${m.noticeContent }">${m.noticeContent }</textarea>
		</div>
		<div class="Btnbox">

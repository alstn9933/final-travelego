    ...
    <section>
            ...
            <div class="action_area">
              ...
              <div class="comments" style="display: none;">
                <form class="comment_form">
                  ...
                  <button
                    type="button"
                    class="btn btn-primary writeCommentBtn"
                    boardNo="${board.togetherNo}"
                  >
                    작성
                  </button>
      ...
      <aside style="display: none;">
        <div>
              ...
              <div class="common_region">
                <ul class="select_region">
                  <c:forEach items="${regionList}" var="reg">
                    <li regionNo="${reg.regionNo}">
                      ${reg.regionCountry }-${reg.regionCity }
                    </li>
                  </c:forEach>
                </ul>
              </div>
          ...
          <button type="button" class="btn btn-primary" id="rollBackBtn">
            되돌리기
          </button>
        </div>
        <div class="streched">
              ...
              <div class="form-group region_form">
                ...
                <div>
                  <input
                    ...
                    autocomplete="off"
                  />
                  <ul class="list-group shadow-sm"></ul>
                </div>
                <span id="regionAlert">

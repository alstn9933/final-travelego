...
<body>
	<div class="admin_page">
		...
		<div id="mySidebar" class="admin_sidebar">
			<a href="local_management"><span><span class="admin_title">여행지
						관리</span><br> <a href="member_management"><span
						class="admin_title"></span>회원 관리</a></span> </a> <a href="QA_member_management" /><span
				class="admin_title">회원문의사항</span><br> <a
				href="report_mamnagement" /><span class="admin_title">신고글 관리</span>
		</div>
		<div id="Contents">
			<h2>게시글 작성</h2>
			<p>여기서 부터 작성하면 됨</p>

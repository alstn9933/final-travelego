				...
				<form action="/memberjoin.do" method="post">
					...
					<div class="col-lg-6">
						<input type="password" class="form-control" id="memberPwRe"
							placeholder="패스워드 확인"><br> <span id="sPwRe"></span>
					</div>
					...
					<div class="col-lg-6	">
						<input type="text" class="form-control onlyHangul" id="memberName"
							name="memberName" placeholder="한글만 입력 가능합니다."><br> <span
							id="sName"></span>
					</div>
					...
					<div class="col-lg-5">
						<input type="text" class="form-control" id="memberNickname"
							name="memberNickname" placeholder="닉네임"><br> <span
							id="sNickname"></span>
					</div>
					<br> <label id="lAge" for="age" class="col-lg-2 control-label">나이</label>
					<div class="col-lg-6">
						<input type="text" class="form-control" id="age" name="age"
							placeholder="나이"><br> <span id="sAge"></span>
					</div>
					...
					<br> <label id="lEmailCode" for="emailCode"
						class="col-lg-2 control-label"">이메일 인증코드</label>
					<div class="col-lg-5">
...
<script>
	var mailCode = "";
	var regExp = "";
	var checkArr = [ false, false, false, false, false, false, false, false,
			false, false ];
